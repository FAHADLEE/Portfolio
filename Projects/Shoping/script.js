var productList = [
  ...
  h2.innerHTML = "clothing for men and women";
  content.append(h2);
  ...
  productList1.map((product) => {
    ...
    let name = (box.name = product.name);
    let preview = (box.name = product.preview);
  ...
  header1.classList.add("section-heading");
  ...
  productList.map((product) => {
    ...
    detailDiv1.classList.add("details");
    section1.append(box1)
